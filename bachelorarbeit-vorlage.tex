...
\begin{Definition}
	...
	\begin{align*}
		\sum_{h \in H} \alpha_h \cdot h \cdot \sum_{k \in K} \beta_k \cdot k = \sum_{h \in H} \sum_{k \in K} \alpha_h \beta_k \cdot h \bullet k
	\end{align*}
	with $\alpha_h, \beta_k \in \C$ and $H, K \in G$ finite subsets.
\end{Definition}
\begin{Definition}
	...
	\end{align*}
\end{Definition}
\textbf{hier hab ich nicht gezeigt, dass es ein Skalarprodukt ist und wie ist die Summe eigtl. definiert?}
\begin{Definition}
