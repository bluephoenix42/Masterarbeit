...
\end{Definition}
\begin{Remark}
	If $G$ is a set instead of a group we can also define a Hilbert space $\ell^2(G)$. Of course we don not have a multiplication in this case.
\end{Remark}
...
\begin{Definition}
	...
	\begin{itemize}
		...
		\item \emph{finite type} if for every $n \in \N$ it has only finitely many $G$-equivariant $n$-cell.
	\end{itemize}
\end{Definition}
\
\begin{Remark}
